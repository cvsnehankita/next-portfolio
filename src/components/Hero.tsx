      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="font-mono text-dark-500 dark:text-dark-400 text-sm mb-4 animate-fade-in">
            <span className="text-primary-500">//</span> Hello, World! I&apos;m
          </div>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-wrap gap-4 mb-12 animate-slide-up animation-delay-600 justify-center lg:justify-start">
          ...
          <div className="flex-shrink-0 animate-fade-in">
            <div className="relative">
              {/* Decorative ring */}
              <div className="absolute -inset-4 bg-gradient-to-br from-primary-400 via-primary-500 to-primary-600 rounded-full opacity-20 blur-lg animate-glow" />
              ...
              {/* Status badge */}
              <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-4 py-2 bg-white dark:bg-dark-800 rounded-full shadow-lg border border-dark-200 dark:border-dark-700">
                <div className="flex items-center gap-2">
                  <span className="relative flex h-3 w-3">
                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
                    <span className="relative inline-flex rounded-full h-3 w-3 bg-green-500"></span>
                  </span>
                  <span className="text-sm font-medium text-dark-700 dark:text-dark-300">Open to work</span>
                </div>
              </div>
            </div>
          </div>
